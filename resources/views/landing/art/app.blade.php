{{-- The owner app: the parcel list an owner actually sees, standing in front
     of the same map the office works on. --}}
<svg class="art" viewBox="0 0 520 420" role="img" aria-label="{{ __('landing.app_art_alt') }}">
    <ellipse cx="260" cy="220" rx="215" ry="185" fill="rgba(230,195,100,.07)"/>

    <g opacity=".55" transform="translate(268 76)">
        <rect x="0" y="0" width="232" height="272" rx="14" fill="#02243D"
              stroke="rgba(171,201,242,.2)" stroke-width="2"/>
        <path class="rd" style="stroke-width:2" d="M0 96 H232 M0 190 H232 M112 0 V272"/>
        <path class="pcl" style="stroke-width:1.6" d="M14 14 h84 v70 h-84 z"/>
        <path class="pcl" style="stroke-width:1.6" d="M124 14 h94 v70 h-94 z"/>
        <path class="pcl-hi" style="stroke-width:2" d="M14 108 h84 v70 h-84 z"/>
        <path class="pcl" style="stroke-width:1.6" d="M124 108 h94 v70 h-94 z"/>
        <path class="pcl" style="stroke-width:1.6" d="M14 202 h204 v56 h-204 z"/>
    </g>

    <g transform="translate(96 32)">
        <rect x="0" y="0" width="228" height="358" rx="34" fill="#001527"
        ...
        <rect x="40" y="332" width="18" height="6" rx="3" fill="#E6C364"/>
        <rect x="90" y="332" width="18" height="6" rx="3" fill="#D6DDE7"/>
        <rect x="140" y="332" width="18" height="6" rx="3" fill="#D6DDE7"/>
        <rect x="190" y="332" width="14" height="6" rx="3" fill="#D6DDE7"/>
    </g>
</svg>
