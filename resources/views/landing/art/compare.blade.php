...
<svg class="art" viewBox="0 0 520 360" role="img" aria-label="{{ __('landing.compare_art_alt') }}">
    ...
    <g transform="translate(38 40)">
        ...
        <text x="31" y="126" fill="#046B4E" class="n" font-size="12"
              font-weight="600" text-anchor="middle">A</text>
        <text x="182" y="127" fill="#0B1C30" font-size="13"
              font-weight="500" text-anchor="end">قطعة 452/ب</text>

        <g font-size="11">
            <text x="182" y="156" fill="#6B7A8C" text-anchor="end">المساحة</text>
            <text x="16" y="156" fill="#0B1C30" class="n" font-size="12" font-weight="600">1,250 m²</text>
            ...
            <text x="16" y="188" fill="#046B4E" font-size="11.5" font-weight="500">محدّث</text>
            <line x1="16" y1="200" x2="182" y2="200" stroke="#EEF1F6" stroke-width="1.4"/>
            <text x="182" y="220" fill="#6B7A8C" text-anchor="end">المخطط</text>
            <text x="16" y="220" fill="#0B1C30" class="n" font-size="12" font-weight="600">1207/A</text>
            ...
            <text x="16" y="252" fill="#0B1C30" font-size="11.5" font-weight="500">سكني</text>
        </g>
    </g>
    ...
    <g transform="translate(286 40)">
        ...
        <text x="31" y="126" fill="#8A6A1F" class="n" font-size="12"
              font-weight="600" text-anchor="middle">B</text>
        <text x="182" y="127" fill="#0B1C30" font-size="13"
              font-weight="500" text-anchor="end">قطعة 208</text>

        <g font-size="11">
            <text x="182" y="156" fill="#6B7A8C" text-anchor="end">المساحة</text>
            <text x="16" y="156" fill="#0B1C30" class="n" font-size="12" font-weight="600">940 m²</text>
            <line x1="16" y1="168" x2="182" y2="168" stroke="#EEF1F6" stroke-width="1.4"/>
            <text x="182" y="188" fill="#6B7A8C" text-anchor="end">حالة الصك</text>
            <text x="16" y="188" fill="#8A6A1F" font-size="11.5" font-weight="500">قديم</text>
            <line x1="16" y1="200" x2="182" y2="200" stroke="#EEF1F6" stroke-width="1.4"/>
            <text x="182" y="220" fill="#6B7A8C" text-anchor="end">المخطط</text>
            <text x="16" y="220" fill="#0B1C30" class="n" font-size="12" font-weight="600">894</text>
            <line x1="16" y1="232" x2="182" y2="232" stroke="#EEF1F6" stroke-width="1.4"/>
            <text x="182" y="252" fill="#6B7A8C" text-anchor="end">نوع الأصل</text>
            <text x="16" y="252" fill="#0B1C30" font-size="11.5" font-weight="500">تجاري</text>
        </g>
    </g>
    ...
    <g transform="translate(216 148)">
        ...
        <text x="44" y="26" fill="#8FA6C0" font-size="10.5"
              text-anchor="middle">الفرق</text>
        <text x="44" y="48" fill="#E6C364" class="n" font-size="17"
