...
<svg class="art" viewBox="0 0 520 400" role="img" aria-label="{{ __('landing.deeds_art_alt') }}">
    ...
    <g transform="translate(146 68)">
        ...
        <text x="236" y="32" fill="#fff" font-family="IBM Plex Sans Arabic" font-size="14"
              font-weight="600" text-anchor="end">صك ملكية مشترك</text>
        <rect x="18" y="17" width="17" height="17" rx="4" fill="#E6C364"/>

        <text x="236" y="82" fill="#0B1C30" font-family="IBM Plex Sans Arabic" font-size="12.5"
              font-weight="600" text-anchor="end">الملّاك</text>

        <g font-family="IBM Plex Sans Arabic" font-size="11.5">
            <rect x="18" y="94" width="220" height="38" rx="9" fill="#F8F9FF"/>
            <circle cx="216" cy="113" r="12" fill="rgba(4,107,78,.13)"/>
            <text x="216" y="117" fill="#046B4E" font-size="11" text-anchor="middle" font-weight="600">م.أ</text>
            <text x="196" y="110" fill="#0B1C30" text-anchor="end" font-weight="600">المالك الأول</text>
            <text x="196" y="125" fill="#6B7A8C" font-size="10" text-anchor="end">حصة الملكية</text>
            <text x="30" y="119" fill="#046B4E" font-family="IBM Plex Sans" font-size="15" font-weight="600">50%</text>

            <rect x="18" y="140" width="220" height="38" rx="9" fill="#F8F9FF"/>
            <circle cx="216" cy="159" r="12" fill="rgba(196,154,60,.18)"/>
            <text x="216" y="163" fill="#8A6A1F" font-size="11" text-anchor="middle" font-weight="600">س.ع</text>
            <text x="196" y="156" fill="#0B1C30" text-anchor="end" font-weight="600">المالك الثاني</text>
            <text x="196" y="171" fill="#6B7A8C" font-size="10" text-anchor="end">حصة الملكية</text>
            <text x="30" y="165" fill="#8A6A1F" font-family="IBM Plex Sans" font-size="15" font-weight="600">30%</text>

            <rect x="18" y="186" width="220" height="38" rx="9" fill="#F8F9FF"/>
            <circle cx="216" cy="205" r="12" fill="rgba(0,36,68,.1)"/>
            <text x="216" y="209" fill="#002444" font-size="11" text-anchor="middle" font-weight="600">ن.ح</text>
            <text x="196" y="202" fill="#0B1C30" text-anchor="end" font-weight="600">المالك الثالث</text>
            <text x="196" y="217" fill="#6B7A8C" font-size="10" text-anchor="end">حصة الملكية</text>
            <text x="30" y="211" fill="#002444" font-family="IBM Plex Sans" font-size="15" font-weight="600">20%</text>
        </g>
        ...
        <text x="238" y="258" fill="#6B7A8C" font-family="IBM Plex Sans Arabic" font-size="11"
              text-anchor="end">تم التحقق من الحدود المكانية</text>
        <text x="238" y="276" fill="#046B4E" font-family="IBM Plex Sans Arabic" font-size="11.5"
              font-weight="600" text-anchor="end">مطابق للقرار المساحي ✓</text>
    </g>
    ...
    <g transform="translate(46 262)">
        ...
        <text x="134" y="25" fill="#0B1C30" font-family="IBM Plex Sans Arabic" font-size="11.5"
              font-weight="600" text-anchor="end">صكوك تحتاج تحديث</text>
        <text x="134" y="43" fill="#8A6A1F" font-family="IBM Plex Sans" font-size="15"
