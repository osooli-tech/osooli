...
@section('content')
    ...
    <div class="max-w-xl mx-auto text-center py-10">
        ...
        {{-- Real action, not a fake subscribe form: opens WhatsApp addressed to
             us, naming the page they were on. Nothing is silently "saved"
             that isn't actually captured anywhere yet. --}}
        <div class="bg-surface-container-lowest dark:bg-[#1a1f2e] rounded-2xl p-5
            ...
            <a href="https://wa.me/{{ preg_replace('/\D/', '', config('landing.contact_whatsapp')) }}?text={{ rawurlencode(__('services.notify_subject', ['service' => $title])) }}"
