...
> **جهاز واحد فقط في نفس الوقت:** كل نجاح لـ `verify-otp` يُلغي أي توكن سابق لنفس المالك فورًا. لو سجّل نفس الرقم دخول من جهاز ثاني، الجهاز الأول يستلم `401` في أول طلب لاحق له ولازم يعيد تسجيل الدخول.
