...
return [
    ...
    'warnings' => [
        ...
        'unmatched_files' => ':count ملف لم يُطابَق بأي قطعة وسيُتجاهل: :files',
        'multi_page' => 'ملفات متعددة الصفحات لا يدل اسمها على قطعة: :files. ارفعها من صفحة «رفع ملف PDF متعدد القطع»، فهي تقسّمها وتطابق كل صفحة بقطعتها.',
        'no_rule' => 'لا يطابق أي ملف في الأرشيف قاعدة تسمية: رقم صك (مثل 310101000001.pdf) أو «القطعة-المخطط» (مثل 131-623.pdf).',
