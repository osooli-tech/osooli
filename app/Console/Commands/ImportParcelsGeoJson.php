 ...
 *
 * The work itself is ParcelGeoJsonImporter, shared with the dashboard import;
 * it runs through Laravel so it works on hosts without Python/GDAL, against
 * whichever database is primary.
 */
